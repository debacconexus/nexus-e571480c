...
process.env.NEXUS_NAME = process.env.NEXUS_NAME || "Community Mental Health Nexus";
process.env.ENTITY_LABEL = process.env.ENTITY_LABEL || "client_treatment_record";
process.env.TABLE_NAME = process.env.TABLE_NAME || "client_treatment_record_records";
'use strict';
